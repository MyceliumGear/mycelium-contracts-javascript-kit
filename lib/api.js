...
MyceliumMultisig.prototype.initEvents = function() {
	...
	var ws = new WebSocket("ws://localhost:10000/jointescrow/common-events");
 ...
 * @param success: (OPTIONAL) Callback function to process after response | function(data,status)
 */
